...
yy: {},
symbols_: {"error":2,"expressions":3,"E":4,"EOF":5,"+":6,"T":7,"-":8,"*":9,"F":10,"/":11,"(":12,")":13,"ID":14,"NUMERO":15,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"+",8:"-",9:"*",11:"/",12:"(",13:")",14:"ID",15:"NUMERO"},
...
switch (yystate) {
case 1:
contador=0;return $$[$0-1];
break;
case 2:
 var temporal=nuevoTemporal()
                this.$ = {
                        TMP:temporal,
                        C3D: `${$$[$0-2].C3D}${$$[$0].C3D}${temporal} = ${$$[$0-2].TMP} + ${$$[$0].TMP} \n`
                     }
